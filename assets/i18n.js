...
(function () {
  ...
  var D = {
    en: {
      ...
      metaCheckout: 'Put Phantom Flash on the trail: the PFLASH-IT Report ($271) at machine speed, or the Full Owlchained Report ($2,717.17) — the hand-built analysis with evidence package and a call with a real human.',
      ...
      hero: 'It\'s your crypto. <span class="glow">PFLASH it.</span> Find it.',
      lede: 'Paste the wallet. Sixty seconds. <strong>See where it went.</strong>',
      ...
      trust1: '⚡ Live blockchain data — nothing simulated', trust2: '⚡ Real wallets. Real transactions. Real answers.', trust3: '⚡ Free for everybody — no account, no card',
      howSub: 'Three steps. All of them free.',
      ...
      deskP2: 'The on-chain record is the whole story. Every transaction ever made with your money is carved into a public ledger that nobody can edit and nobody can delete. Phantom Flash reads that ledger the way professional analysts do — and shows it to you for free. Whatever the truth is, it\'s yours.',
      ...
      owlLabel: '🦉 Full Owlchained Report', owlTag: 'The full analysis — built by hand, chained down.',
      owl1: '<strong>Everything in the PFLASH-IT Report</strong>, plus:',
      owl2: 'Hand-built tracing workup — every hop verified, whatever the truth turns out to be',
      ...
      disclaimer: 'The Phantom Flash Owlchained Report is a blockchain analysis provided for informational purposes only. It is not a guarantee or commitment of any kind. Phantom Flash and its operators are not responsible for any incorrect, incomplete, or outdated tracing information in any report or free scan. Results are not guaranteed, and recovery of funds is not promised or implied. Nothing on this site is legal, financial, or investment advice. Free scan data is retrieved live from public blockchain sources and is presented as-is. Phantom Flash is an independent blockchain analysis service and is not affiliated with any cryptocurrency wallet, exchange, or software product. Wallet addresses entered for a scan are recorded to strengthen the Phantom Flash tracing network.',
      ...
      systemTitle: 'The System', liveData: '● LIVE BLOCKCHAIN DATA', systemSub: 'This is where your money actually went. The wallet you PFLASHED sits at the center; every wallet it transacted with orbits it, sized by volume. Drag to rotate, scroll to zoom, <strong>click any wallet</strong> for the amounts and what the pattern most likely means. <strong>All of it — every world — free.</strong>',
      ...
      bagHonesty: '💰 bags = this wallet’s share of the observed first-hop volume with your scanned wallet — not the absolute balance of that address.',
    ...
    es: {
      ...
      eyebrow: '⚡ Phantom Flash Owlchained Report', hero: '¿Tu inversión es real?<br><span class="glow">Descúbrelo en 60 segundos.</span>',
  ...
  function applyScan(){
    ...
    set('.hud', '<span class="live">●</span> FIRST HOP — LIVE · INHABITED · FREE');
    set('.controls-hint', lang==='en' ? 'drag to rotate · scroll to zoom · click a wallet for details' : (lang==='vi' ? 'kéo để xoay · cuộn để phóng to · nhấp hành tinh để ghé thăm' : (lang==='zh' ? '拖动旋转 · 滚轮缩放 · 点击星球查看' : 'drag to orbit · scroll to zoom · click a planet')));
    /* v11 (2026-08-21): paywall removed — deep-trace section, cta-band, and
       mini-locks no longer exist on scan.html; their rewrites are gone too. */
    var rt=document.querySelectorAll('h2.section-title')[1]; if(rt){ rt.childNodes[0].textContent=t('recentTx')+' '; var sp=rt.querySelector('span'); if(sp && t('recentSub')) sp.textContent=t('recentSub'); }
