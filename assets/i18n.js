...
(function () {
  ...
  var D = {
    en: {
      ...
      howSub: 'Three steps. The first one is free and takes sixty seconds.',
      ...
      deskP2: 'The on-chain record is the whole story. Every transaction ever made with your money is carved into a public ledger that nobody can edit and nobody can delete. The Phantom Flash Owlchained Report reads that ledger the way professional analysts do — until the full picture is on the table. Whatever the truth is, it\'s yours.',
  ...
  function applyScan(){
    ...
    set('.hud', lang==='vi' ? '<span class="live">●</span> '+t('hud') : '<span class="live">●</span> FIRST HOP — LIVE &nbsp;·&nbsp; <span style="color:var(--amber)">🔒 DEEPER HOPS — LOCKED</span>');
